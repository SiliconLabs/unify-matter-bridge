...
#include "emulate_colorcontrol.hpp"
...
constexpr uint8_t ON_OFF_LIGHTING_FEATURE_MAP_MASK = 0x01;
constexpr uint8_t LEVEL_ONOFF_DEPENDENCY_FEATURE_MAP_MASK = 0x01;
constexpr uint8_t LEVEL_LIGHTING_FEATURE_MAP_MASK = 0x02;
constexpr uint8_t LEVEL_FREQUENCY_FEATURE_MAP_MASK = 0x04;
constexpr uint8_t DOORLOCK_FEATURE_MAP_MASK = 0x00;
...
ClusterEmulator::ClusterEmulator()
{
    std::vector<std::shared_ptr<EmulatorInterface>> emulators = { std::make_shared<EmulateIdentify>(),
                                                                  ...
                                                                  std::make_shared<EmulateColorControl>() };
